...
const DeliveryScreen = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ marginTop: HEIGHT * 0.075, paddingHorizontal: WIDTH * 0.06, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Pressable style={{ backgroundColor: colors.lightGray, width: WIDTH * 0.12, height: WIDTH * 0.12, alignItems: 'center', justifyContent: 'center', borderRadius: WIDTH * 0.03, marginRight: WIDTH * 0.05 }}><Image source={gpsIcon} /></Pressable>
            </View>

            <Image source={rute} style={{ top: HEIGHT * 0.195, left: WIDTH * 0.22, position: 'absolute' }} />
