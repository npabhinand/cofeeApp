...
const MyOrderComponent: React.FC<orderDetailProps> = (props) => {
    ...
    return (
        <View style={{ padding: HEIGHT * 0.025, width: WIDTH * 0.9, alignSelf: 'center', marginTop: HEIGHT * 0.02, gap: 5, backgroundColor: colors.commonWhite, borderRadius: 10 }}>
            ...
            <Modal visible={isVisible} animationType="slide" transparent={true}>
                <OrderDetailsComponent item={item} handleModal={handleModal} marginTop={HEIGHT * 0.16} />
            </Modal>
        </View>
    );
};
