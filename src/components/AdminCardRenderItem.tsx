...
const AdminCardRenderItem: React.FC<cardProps> = (props) => {
    ...
    return (
        <Pressable style={{ width: WIDTH * 0.42, height: 150, backgroundColor: `${colors.brownColor}30`, borderRadius: 10, padding: HEIGHT * 0.02, marginBottom: HEIGHT * 0.02, shadowColor: colors.commonBlack, shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.22, shadowRadius: 2.22, elevation: 3, borderColor: colors.brownColor, borderWidth: 0.5, marginLeft: WIDTH * 0.05 }} onPress={() => navigation.navigate(item.navigate)}>
